    ...
    dropdownItems: [
      {
        ...
        href: "#",
        description:
          "Real-time facial expression analysis to understand student engagement and emotional state",
      },
      {
        title: "AI Tutor",
        href: "#",
        description: "Personalized learning assistant that adapts to your emotional state and learning pace",
      },
      {
        title: "Analytics",
        href: "#",
        description: "Comprehensive insights into learning patterns, engagement, and emotional trends",
      },
      {
        title: "Mindfulness",
        href: "#",
        description: "Built-in mindfulness exercises and stress management tools for optimal learning",
      },
    ],
  },
  {
    ...
    dropdownItems: [
      {
        ...
        href: "#",
        description:
          "Emotion-aware learning solutions designed for elementary and secondary education",
      },
      {
        title: "Higher Education",
        href: "#",
        description: "Advanced analytics and personalization for colleges and universities",
      },
      {
        title: "Special Needs",
        href: "#",
        description: "Specialized tools and adaptations for students with learning differences",
      },
      {
        title: "Homeschool",
        href: "#",
        description: "Comprehensive learning platform for homeschool families and educators",
      },
    ],
  },
  { label: "Pricing", href: "#" },
    ...
    dropdownItems: [
      {
        ...
        href: "#",
        description:
          "Real-world success stories and implementation examples from schools and institutions",
      },
      {
        title: "Research",
        href: "#",
        description: "Latest findings in emotion-aware learning and educational technology research",
      },
      {
        title: "Support",
        href: "#",
        description: "Help center, documentation, and technical support resources",
      },
      {
        title: "Blog",
        href: "#",
        description: "Insights, tips, and updates on the future of personalized education",
      },
    ],
  },
];
    ...
    <section className="absolute top-5 left-1/2 z-50 w-[min(90%,700px)] -translate-x-1/2 rounded-full border bg-background/70 backdrop-blur-md lg:top-12">
      <div className="flex items-center justify-between px-6 py-3">
        <a href={logo.url} className="flex shrink-0 items-center gap-2" title={logo.title}>
          <span className="text-xl font-bold text-primary font-[var(--font-display)]">EduPulse</span>
        </a>
        ...
        <div className="flex items-center gap-2.5">
          ...
          <a href="/start-trial" className="max-lg:hidden">
            <Button>
